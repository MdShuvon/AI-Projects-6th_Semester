...
This project was developed by **Md Shuvon with classmates** as part of the **6th Semester University Laboratory Projects**. The prediction is educational and statistical; it is not an official FIFA forecast or a guarantee of real-world match results.
